...
class AllTestsCase(TestCase):
    ...
    def test_model_city_duplicate(self):
        """Тестування виникнення помилки під час створення дубля міста"""
        city = City(name="A")
        with self.assertRaises(ValidationError):
            city.full_clean()

    def test_model_train_duplicate(self):
        """Тестування виникнення помилки під час створення дубля поїзда"""
    ...
    def test_message_error_more_time(self):
        ...
        self.assertContains(response, 'Час у дорозі більше заданого', 1, 200)
